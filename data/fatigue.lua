...
d.normal = {
    { time = 0, event = { 'dmgCycle', 0 },  text = "THREE MINUTES",     desc = "", color = "O", },
    { time = 60, event = { 'dmgCycle', 0 },  text = "REMAIN 2 MINUTES",     desc = "", color = "A", },
    { time = 90, event = { 'dmgCycle', 0 },  text = "REMAIN 90 SECONDS",     desc = "", color = "A", },
    { time = 120, event = { 'dmgCycle', 0 },  text = "REMAIN 1 MINUTE",     desc = "", color = "A", },
    { time = 150, event = { 'dmgCycle', 0 },  text = "REMAIN 30 SECONDS",     desc = "", color = "A", },
    { time = 160, event = { 'dmgCycle', 0 },  text = "REMAIN 20 SECONDS",     desc = "", color = "A", },
    { time = 170, event = { 'dmgCycle', 0 },  text = "REMAIN 10 SECONDS",     desc = "", color = "A", },
    { time = 175, event = { 'dmgCycle', 0 },  text = "REMAIN 5 SECONDS",     desc = "", color = "A", },
    { time = 180,  event = { 'extraQuestBase', .2, 'animDuration', .5 } },
    { time = 180, event = { 'extraQuestBase', .2, 'animDuration', .5 } },
    { time = 180, event = { 'extraQuestBase', .2, 'animDuration', 1 } },
    { time = 180, event = { 'dmgTimerMul', -.1, 'animDuration', 1 } },
    { time = 180, event = { 'dmgCycle', -.5, 'dmgWrong', 1 } },
    { time = 180, event = { 'dmgTimerMul', -.1, 'dmgHeal', -1, 'animDuration', 1 } },
    { time = 180, event = { 'dmgTimerMul', -.1, 'dmgWrong', 1 } },
    { time = 180, event = { 'dmgTimerMul', -.05, 'dmgCycle', -.5, 'animDuration', 1 }, final = true },
    { time = 180, event = { 'dmgTimerMul', -.05 } },
    { time = 180, event = { 'dmgTimerMul', -.05 } },
    { time = 180, event = { 'dmgTimerMul', -.05 } },
    { time = 180, event = { 'atkBufferCap', 6, 'animDuration', 2, 'maxQuestSize', 1 }, text = "TIME OVER",                 desc = "",     duration = 26, color = 'lB', },
    { time = 180, event = { 'atkBufferCap', 6, 'animDuration', 4, 'extraQuestVar', 1 } },
    { time = 180, event = { 'atkBufferCap', 6, 'animDuration', 4 } },
    { time = 180, event = { 'animDuration', 5 }, --[[21]] },
    { time = 180, event = { 'animDuration', 5 }, --[[26]]                              text = "" },
    { time = 180, event = { 'animDuration', 10, 'lifeLeak', 1200 }, --[[36]]},
    { time = 180, event = { 'animDuration', 12 }, --[[48]] },
    { time = 180, event = { 'animDuration', 14 }, --[[62]]                             text = "" },
