...
d.normal = {
    ...
    { time = 180, event = { 'dmgTimerMul', -.1, 'animDuration', 1 },                   text = "FATIGUE SETS IN_",          desc = "TimerSpeed++" },
    { time = 180, event = { 'dmgCycle', -.5, 'dmgWrong', 1 },                          text = "YOUR BODY GROWS WEAK_",     desc = "DmgCycle--   Damage++" },
    { time = 180, event = { 'dmgTimerMul', -.1, 'dmgHeal', -1, 'animDuration', 1 },    text = "ALL SENSES BLUR TOGETHER_", desc = "TimerSpeed++   Heal--" },
    { time = 180, event = { 'dmgTimerMul', -.1, 'dmgWrong', 1 },                       text = "YOUR CONSCIOUSNESS FADES_", desc = "TimerSpeed++   Damage++" },
    { time = 180, event = { 'dmgTimerMul', -.05, 'dmgCycle', -.5, 'animDuration', 1 }, text = "THIS IS THE END.",          desc = "TimerSpeed++   DmgCycle--", final = true },
    { time = 180, event = { 'dmgTimerMul', -.05 } },
    { time = 180, event = { 'dmgTimerMul', -.05 } },
    { time = 180, event = { 'dmgTimerMul', -.05 } },
    { time = 180, event = { 'atkBufferCap', 6, 'animDuration', 2, 'maxQuestSize', 1 }, text = "FAREWELL.",                 desc = "QuestDifficulty++++++",     duration = 26, color = 'lB', },
    ...
    { time = 180, event = { 'animDuration', 10, 'lifeLeak', 1 }, --[[36]]             text = "ANGINA.",                   desc = "HP leak",                   color = 'DR' },
