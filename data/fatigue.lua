...
d.normal = {
    { time = 90000,  event = { 'extraQuestBase', .2, 'animDuration', .5 } },
    { time = 180000, event = { 'extraQuestBase', .2, 'animDuration', .5 } },
    { time = 240000, event = { 'extraQuestBase', .2, 'animDuration', 1 } },
    { time = 300000, event = { 'dmgTimerMul', -.1, 'animDuration', 1 },                   text = "FATIGUE SETS IN_",          desc = "TimerSpeed++" },
    { time = 330000, event = { 'dmgCycle', -.5, 'dmgWrong', 1 },                          text = "YOUR BODY GROWS WEAK_",     desc = "DmgCycle--   Damage++" },
    { time = 360000, event = { 'dmgTimerMul', -.1, 'dmgHeal', -1, 'animDuration', 1 },    text = "ALL SENSES BLUR TOGETHER_", desc = "TimerSpeed++   Heal--" },
    { time = 390000, event = { 'dmgTimerMul', -.1, 'dmgWrong', 1 },                       text = "YOUR CONSCIOUSNESS FADES_", desc = "TimerSpeed++   Damage++" },
    { time = 420000, event = { 'dmgTimerMul', -.05, 'dmgCycle', -.5, 'animDuration', 1 }, text = "THIS IS THE END.",          desc = "TimerSpeed++   DmgCycle--", final = true },
    { time = 422000, event = { 'dmgTimerMul', -.05 } },
    { time = 425000, event = { 'dmgTimerMul', -.05 } },
    { time = 430000, event = { 'dmgTimerMul', -.05 } },
    { time = 480000, event = { 'atkBufferCap', 6, 'animDuration', 2, 'maxQuestSize', 1 }, text = "FAREWELL.",                 desc = "QuestDifficulty++++++",     duration = 26, color = 'lB', },
    { time = 485000, event = { 'atkBufferCap', 6, 'animDuration', 4, 'extraQuestVar', 1 } },
    { time = 490000, event = { 'atkBufferCap', 6, 'animDuration', 4 } },
    { time = 500000, event = { 'animDuration', 5 }, --[[21]] },
    { time = 510000, event = { 'animDuration', 5 }, --[[26]]                              text = "" },
    { time = 520000, event = { 'animDuration', 10, 'lifeLeak', .2 }, --[[36]]             text = "ANGINA.",                   desc = "HP leak",                   color = 'DR' },
    { time = 540000, event = { 'animDuration', 12 }, --[[48]] },
    { time = 560000, event = { 'animDuration', 14 }, --[[62]]                             text = "" },
