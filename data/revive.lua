...
local function noCrit() return not GAME.crit end
local function yesCrit() return GAME.crit end
...
---@type Prompt[]
local d = {
    { rank = { 1, 6 }, prompt = 'activate',             target = 30,  short = "Activate 30",             text = "Activate 30 cards" },
    --{ rank = { 3, 4 }, prompt = 'activate',             target = 80,  short = "Activate 80",             text = "Activate 80 cards" },
    { rank = { 1, 6 }, prompt = 'cancel',               target = 40,  short = "Cancel 40",               text = "Cancel 40 cards" },
    --{ rank = { 3, 4 }, prompt = 'cancel',               target = 100, short = "Cancel 100",              text = "Cancel 100 cards" },
    { rank = { 1, 6 }, prompt = 'flip',                 target = 50,  short = "Flip 50",                 text = "Flip 50 cards" },
    ...
    { rank = { 1, 6 }, prompt = 'flip_single',          target = 10,  short = "Flip single 10",          text = "Flip a single card\n10 times in a row",       cond = function() return not (URM and GAME.mod.AS == 2) end },
    ...
    { rank = { 1, 6 }, prompt = 'commit',               target = 6,   short = "Commit 6x",               text = "Commit 6 times" },
    ...
    { rank = { 1, 6 }, prompt = 'commit_$1',            target = 2,   short = "Commit $1 2x",            text = "Commit 2 times\nwith $1",                     init = rndMod },
    --{ rank = { 3, 4 }, prompt = 'commit_$1',            target = 4,   short = "Commit $1 4x",            text = "Commit 4 times\nwith $1",                     init = rndMod },
    { rank = { 2, 6 }, prompt = 'commit_$1_row',        target = 2,   short = "2 Chain with $1",         text = "Commit 2 times\nwith $1 in a row",            init = rndMod },
    --{ rank = { 3, 6 }, prompt = 'commit_$1_row',        target = 3,   short = "3 Chain with $1",         text = "Commit 3 times\nwith $1 in a row",            init = rndMod },
    { rank = { 1, 6 }, prompt = 'commit_no_$1_row',     target = 2,   short = "2 chain without $1",      text = "Commit 2 times\nwithout $1 in a row",         init = rndMod2 },
    --{ rank = { 3, 5 }, prompt = 'commit_no_$1_row',     target = 3,   short = "3 chain without $1",      text = "Commit 3 times\nwithout $1 in a row",         init = rndMod2 },
    { rank = { 1, 6 }, prompt = 'commit_0',             target = 2,   short = "Commit NOTHING 2x",       text = "Commit NOTHING\n2 times" },
    ...
    { rank = { 3, 6 }, prompt = 'commit_2card',         target = 4,   short = "Commit 2 cards 4x",       text = "Commit 4 times with\n2 cards on first commit" },
    ...
    { rank = { 1, 6 }, prompt = 'pass',                 target = 10,  short = "Pass 10",                 text = "Pass 10 times" },
    --{ rank = { 5, 6 }, prompt = 'pass',                 target = 20,  short = "Pass 20",                 text = "Pass 20 times" },
    { rank = { 2, 6 }, prompt = 'pass_$1',              target = 2,   short = "Pass 2 with $1",          text = "Pass 2 times\nwith $1",                       init = rndMod, cond = notEDHandEDP },
    --{ rank = { 3, 6 }, prompt = 'pass_$1',              target = 3,   short = "Pass 3 with $1",          text = "Pass 3 times\nwith $1",                       init = rndMod, cond = notEDHandEDP },
    --{ rank = { 4, 6 }, prompt = 'pass_$1',              target = 4,   short = "Pass 4 with $1",          text = "Pass 4 times\nwith $1",                       init = rndMod, cond = notEDHandEDP },
    { rank = { 2, 6 }, prompt = 'pass_perfect',         target = 6,   short = "6x perf",                 text = "Get 6 perfect passes" },
    --{ rank = { 5, 6 }, prompt = 'pass_perfect',         target = 12,  short = "12x perf",                text = "Get 12 perfect passes" },
    { rank = { 2, 6 }, prompt = 'pass_imperfect',       target = 6,   short = "6x im-perf",              text = "Get 6 imperfect passes",                       cond = notENH },
    --{ rank = { 5, 6 }, prompt = 'pass_imperfect',       target = 12,  short = "12x im-perf",             text = "Get 12 imperfect passes",                      cond = notENH },
    { rank = { 4, 6 }, prompt = 'pass_imperfect_row',   target = 3,   short = "3x chain im-perf",        text = "Get 3 imperfect\npasses in a row",             cond = notENH },
    --{ rank = { 5, 6 }, prompt = 'pass_imperfect_row',   target = 8,   short = "8x chain im-perf",        text = "Get 8 imperfect\npasses in a row",             cond = notENH },
    { rank = { 2, 6 }, prompt = 'pass_perfect_row',     target = 4,   short = "4x chain perf",           text = "Get 4 perfect\npasses in a row" },
    ...
    --{ rank = { 2, 6 }, prompt = 'pass_second',          target = 4,   short = "2nd quest 4x",            text = "Pass the second\nquest 4 times" },
    ...
    --{ rank = { 2, 6 }, prompt = 'pass_third',           target = 1,   short = "3rd quest",               text = "Pass the third\nquest once",                   cond = EDP },
    ...
    --{ rank = { 2, 8 }, prompt = 'b2b_break_4',          target = 1,   short = "Break B2B 4x",            text = "Break B2B chain\nat B2B x4",                   cond = notENH or noCrit },
    ...
    --{ rank = { 4, 6 }, prompt = 'b2b_break_windup',     target = 1,   short = "Break B2B at a windup",   text = "Break B2B at a windup",                        cond = notENHorF9wind or noCrit },
    ...
    { rank = { 1, 6 }, prompt = 'heal',                 target = 8,   short = "Heal 8 HP",               text = "Heal 8 HP",                                    cond = notEMS },
    --{ rank = { 2, 4 }, prompt = 'heal',                 target = 20,  short = "Heal 20 HP",              text = "Heal 20 HP",                                   cond = notEMS },
    { rank = { 1, 6 }, prompt = 'send',                 target = 6,   short = "Send 6",                  text = "Send 6 Attack" },
    ...
    --{ rank = { 3, 6 }, prompt = 'pass_windup',          target = 1,   short = "Windup",                  text = "Pass a windup",                               cond = F9wind or noCrit },
    --{ rank = { 3, 5 }, prompt = 'pass_windup3',         target = 1,   short = "Windup3+",                text = "Pass a Lv.3+ windup",                         cond = F9wind3 },
    --{ rank = { 5, 6 }, prompt = 'pass_windup_inb2b',    target = 1,   short = "Windup with B2B",         text = "Pass a windup\nduring B2B charge",            cond = F9wind or noCrit },
    --{ rank = { 4, 6 }, prompt = 'pass_windup',          target = 4,   short = "Windup x 4",              text = "Pass 4 windups",                              cond = F9wind or noCrit },
    --{ rank = { 4, 6 }, prompt = 'pass_windup_perfect',  target = 1,   short = "Windup perf",             text = "Pass a windup\nperfectly",                    cond = F9wind or noCrit },
   -- { rank = { 6, 6 }, prompt = 'pass_windup_inb2b',    target = 3,   short = "Windup x 3 with B2B",     text = "Pass 4 windups\nduring a B2B charge",         cond = F9wind },
    ...
    { rank = { 2, 6 }, prompt = 'dmg_time',             target = 4,   short = "Take Dmg 4x",             text = "Take damage 4 times",                         cond = notEMS },
    --{ rank = { 3, 3 }, prompt = 'dmg_time',             target = 8,   short = "Take Dmg 8x",             text = "Take damage 8 times",                         cond = notEMS },
    { rank = { 2, 6 }, prompt = 'dmg_amount',           target = 10,  short = "Lose 10 HP",              text = "Take 10 damage total",                        cond = notEMS },
    --{ rank = { 4, 6 }, prompt = 'dmg_amount',           target = 20,  short = "Lose 20 HP",              text = "Take 20 damage total",                        cond = notEMS },
    { rank = { 3, 6 }, prompt = 'timedmg_time',         target = 2,   short = "Take Time Dmg 2x",        text = "Take time damage 2 times",                    cond = F6 },
    ...
    --{ rank = { 2, 4 }, prompt = 'keep_no_commit',       target = 6,   short = "No commit 6s",            text = "Don't commit\nfor 6 seconds",                 cond = function() return math.max(GAME.floor, GAME.negFloor) <= 5 and not (URM and GAME.mod.GV == 2) end },
    ...
    { rank = { 6, 6 }, prompt = 'flip',                 target = 65535,  short = "Flip 65,535",                 text = "Flip 65,535 cards",                      cond = yesCrit },
}
